...
def successor_fn(state):  # Lookup list of successor states
    ...
    succesorStates = STATE_SPACE[state]

    for state in failStates:
        if succesorStates.__contains__(state):
            succesorStates.remove(state)
...
STATE_SPACE = {('W', 'W', 'W', 'W') :[('E','E','W','W'),('E','W','E','W'),('E','W','W','E'), ('E','W','W','W')],
